...
mysql_query("SET NAMES 'utf8'");
 ...
 $result = mysql_query("select * from  publish where class='opera'");
 
?>

<center><img src="in_opera.jpg" height="10%" width="70%" /></center>
...
echo "<center><input type='hidden' name='class' value='opera' /></center>";
...
echo "<tr>
		<td><a href='c_publish.php?pid=".$row->p_id."&b=1'>".$row->title."</a></td>
		<td>".$row->username."</td>
		<td>".$row->datetime."</td>
	  </tr>";

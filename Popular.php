...
mysql_query("SET NAMES 'utf8'");
 ...
 $result = mysql_db_query("winter","select * from  publish where class='popular'");
 
?>

<center><img src="in_popular.jpg" height="10%" width="70%" /></center>
...
echo "<center><input type='hidden' name='class' value='popular' /></center>";
...
echo "<tr>
		<td><a href='c_publish.php?pid=".$row->p_id."&b=2'>".$row->title."</a></td>
		<td>".$row->username."</td>
		<td>".$row->datetime."</td>
	  </tr>";
